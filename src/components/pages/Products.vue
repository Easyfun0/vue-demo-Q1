        ...
        <table class="table mt-4">
            <thead>
                <tr style="color:red;">
                    ...
                    <th width="100" style="font-size:2em">電力(%)</th>
                    <th width="100" style="font-size:2em">警報</th>
                    <th width="100" style="font-size:2em">其他</th>
                </tr>
            </thead>
            <tbody>
                <tr v-for="(item) in products" :key="item.id">
                    ...
                    <td class="text-center" style="font-size:30px"> {{item.price}} </td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="col-sm-10">
                ...
                <div class="form-group">
                <label for="description">地點描述</label>
                ...
                <div class="form-check">
                    ...
                    :true-value="1" :false-value="1" id="is_enabled">
